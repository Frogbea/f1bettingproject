...
class homePage(QMainWindow):
    def __init__(self, init_self=None):
        QMainWindow.__init__(self)
    ...
    def updateDisplay(self):
        # Find the QLabel that displays currentEC and update its text
        displayCurrent = self.findChild(QLabel, 'displayCurrent')
        if displayCurrent:
            displayCurrent.setText('Current Emily Coins: ' + str(currentEC))
...
if __name__ == "__main__":
    ...
    homepage = homePage(init_self=homePage.__init__)
