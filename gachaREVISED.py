...
class Welcomepage(QMainWindow):
    def __init__(self):
        ...
        layout = QVBoxLayout()
        # welcome button
        welcome = QLabel('WELCOME! TO THE GREATESTGACHA PROGRAM EVER CREATED \n IN ALL OF MANKIND!! \n*BOOM* *POW* *EXPLSION* hello world', alignment=QtCore.Qt.AlignCenter)
...
if __name__ == '__main__':
    ...
    widget.setCurrentWidget(welcome)  
    widget.setWindowTitle('Amazing and cool Gacha system')
